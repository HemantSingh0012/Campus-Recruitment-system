...
import { FaBuilding, FaUserGraduate, FaArrowRight } from 'react-icons/fa';
        ...
        <Row className="justify-content-center">
          <Col md={8} lg={6} xl={5}>
            <div className="text-center mb-4">
              <h1 className="display-5 fw-bold text-primary mb-3">Join CRS Today</h1>
              <p className="text-muted lead">Choose your account type to get started</p>
            </div>
            ...
            <Card className="shadow-lg border-0 card-hover">
                    ...
                    <Button variant="light" size="lg" className="auth-btn company-btn">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 text-start ms-3">
                          ...
                          <p className="mb-0 text-muted small">Hire top talent for your organization</p>
                        </div>
                    ...
                    <Button variant="light" size="lg" className="auth-btn student-btn">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 text-start ms-3">
                          ...
                          <p className="mb-0 text-muted small">Find your dream job opportunity</p>
                        </div>
                        <FaArrowRight className="ms-2 btn-arrow" />
                      </div>
                    </Button>
              ...
              <Card.Footer className="text-center border-0 bg-light py-4">
                <p className="mb-0">
                  ...
                  <Link to={ROUTES.LOG_IN} className="text-decoration-none fw-medium">
                    Log In
                  </Link>
                </p>
              </Card.Footer>
